...
class Picking(models.Model):
    ...
    def button_validate(self):
        for rec in self:
            ...
            date_done = fields.Datetime.from_string(rec.date_done)
            delivery_created = fields.Datetime.from_string(rec.create_date)
            delivery_scheduled = fields.Datetime.from_string(rec.scheduled_date)
