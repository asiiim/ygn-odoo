...
class MessagingList(models.Model):
    ...
    sms_multiple_id = fields.Many2many('ygen.sms.multiple', 'group_multi_sms_rel', 'sms_multiple_id', 'sms_messaging_list_ids', string="Multiple SMS", track_visibility='onchange')
