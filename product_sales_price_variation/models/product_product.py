    ...
    def compute_sales_price(self):
        for product in self:
            if product.can_depend_base:
                ...
                _logger.warning(product.product_tmpl_id.uom_id.id)
                _logger.warning(product.name)
                _logger.warning(product.base_product_id.product_tmpl_id.uom_id.id)

                if product.product_tmpl_id.uom_id != product.base_product_id.product_tmpl_id.uom_id:
